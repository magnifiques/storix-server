...
const getExpenseByCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const getExpenseByCategorySummaryRow = yield prisma.expenseByCategory.findMany({
            orderBy: {
                date: "desc",
            },
        });
        const expenseByCategorySummary = getExpenseByCategorySummaryRow.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString() })));
